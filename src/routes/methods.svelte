...
<Tile light>
    ...
    <OrderedList class="ol" expressive>
        <ListItem class="li">
            Overall skill: We selected the models that ranked higher based on a comprehensive skill assessment over the conterminous United States (Ashfaq et al., 2022 manuscript to be submitted soon).
        </ListItem>
        <ListItem class="li">
